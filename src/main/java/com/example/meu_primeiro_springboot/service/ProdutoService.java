...
import com.example.meu_primeiro_springboot.exceptions.RecursoNaoEcontradoException;
...
public class ProdutoService {
    ...
    public Produto buscarPorId(Long id) {
        return produtoRepository.findById(id)
                .orElseThrow(() -> new RecursoNaoEcontradoException("Produto com ID "+id+" não encontrado."));
    }
